...
export default function MultiTenant() {
  const [selectedOrg, setSelectedOrg] = useState("Prime Fund Capital");
  const [selectedTeam, setSelectedTeam] = useState("Trading Desk");
      ...
      <div className="tenant-panel">
        ...
        <select
          ...
          onChange={(e) => {
            ...
            setSelectedTeam(teams[e.target.value][0]);
          }}
        >
          {orgs.map((org) => (
