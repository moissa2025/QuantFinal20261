...
export default function Branding() {
  const [primaryColor, setPrimaryColor] = useState("#0070f3"    </DockablePanel>
  );
  const [accentColor, setAccentColor] = useState("#00c853"    </DockablePanel>
  );
  const [radius, setRadius] = useState(6    </DockablePanel>
  );
  const [font, setFont] = useState("Inter"    </DockablePanel>
  );
